...
cwl_entries = {'USD+': 
               {'id': 'USD+', 'name': 'USD+', 'symbol': 'USD+',
                ...
                'usd_balance': 369.583798212, 'blockchain': 'Base', 'type': 'EVM', 'exchange_rate': 1.002},
                'bsdETH': 
                {'id': 'bsdETH', 'name': 'Based ETH', 'symbol': 'bsdETH', 'contract_address': '0xCb327b99fF831bF8223cCEd12B1338FF3aA322Ff',
                           ...
                           'blockchain': 'Base', 'type': 'EVM', 'exchange_rate': 2796.14}
                }
arbitrum_eth_balance = {'id': 'ETH', 'symbol': 'ETH', 'name': 'Ethereum', 'native_balance': 0.23859492544325733, 'blockchain': 'Base', 'type': 'EVM'}
...
def test_get_native_balance_from_blockscout():
    ...
    assert arbitrum_eth_balance['id'] == 'ETH'
...
def test_sum_tokens_usd_balances():
    ...
    assert mon_wallet.sum_balance_by_blockchain()['Base'] == cwl_entries['USD+']['usd_balance'] + cwl_entries['bsdETH']['usd_balance'] + arbitrum_eth_balance2['Base']['ETH'].usd_balance
