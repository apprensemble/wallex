from myblockscoutlib import Token,Wallet,mantle,Config
...
mantle_eth_balance = {'id': 'ETH', 'symbol': 'ETH', 'name': 'Ethereum', 'native_balance': 0.23859492544325733, 'blockchain': 'Base', 'type': 'EVM'}
...
def add_json_entries():
    ...
    assert mon_wallet.entries['ETH']['native_balance'] == mantle_eth_balance['native_balance']
